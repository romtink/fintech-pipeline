-- This code references the staging table to display fraud count/rate, total transactions, and average fraud amount grouped by gender and age.
...
SELECT
    -- Age buckets are <30yrs, 30-50yrs, >50yrs
    CASE
